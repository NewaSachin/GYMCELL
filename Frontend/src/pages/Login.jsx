...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (cart?.products.length > 0 && guestId) {
        await dispatch(mergeCart({ guestId, user: userData }));
      }
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
          ...
          >
            <div className="flex justify-center mb-6">
              <h2 className="text-xl font-medium">Gymcell</h2>
            </div>
...
//               <h2 className="text-xl font-bold">GYM | CELL</h2>
//               <p className="text-2xl font-bold mt-2">Hey there! 👋</p>
