...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    //Determine if the user is loggeed in or guest
...
//@route PUT /api/cart
//@desc  Update product quantity in the cart for a quest or login user
//  @access public
...
//@dec Remove product from the cart
// @access Public
...
//@route GET /api/cart
// @desc GET logged-in user's orguest cart
//@access public
...
// @desc Merge guest cart into user cart on loggedin
//@access Private
router.post("/merge", protect, async (req, res) => {
  ...
  try {
    ...
    if (guestCart)
    {
      ...
      if (userCart) {
        //Guest cart has already been mergeed,return user cart
